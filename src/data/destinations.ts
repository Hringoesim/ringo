...
export const COUNTRIES: Destination[] = [
  { id: 'usa', label: 'United States', kind: 'country', countries: 1, flag: '🇺🇸', region: 'North America' },
  { id: 'australia', label: 'Australia', kind: 'country', countries: 1, flag: '🇦🇺', region: 'Oceania' },
  { id: 'brazil', label: 'Brazil', kind: 'country', countries: 1, flag: '🇧🇷', region: 'Latin America' },
  { id: 'canada', label: 'Canada', kind: 'country', countries: 1, flag: '🇨🇦', region: 'North America' },
  { id: 'china', label: 'China', kind: 'country', countries: 1, flag: '🇨🇳', region: 'Asia-Pacific' },
  { id: 'colombia', label: 'Colombia', kind: 'country', countries: 1, flag: '🇨🇴', region: 'Latin America' },
  { id: 'egypt', label: 'Egypt', kind: 'country', countries: 1, flag: '🇪🇬', region: 'Middle East' },
  { id: 'france', label: 'France', kind: 'country', countries: 1, flag: '🇫🇷', region: 'Europe' },
  { id: 'germany', label: 'Germany', kind: 'country', countries: 1, flag: '🇩🇪', region: 'Europe' },
  { id: 'greece', label: 'Greece', kind: 'country', countries: 1, flag: '🇬🇷', region: 'Europe' },
  { id: 'iceland', label: 'Iceland', kind: 'country', countries: 1, flag: '🇮🇸', region: 'Europe' },
  { id: 'india', label: 'India', kind: 'country', countries: 1, flag: '🇮🇳', region: 'Asia-Pacific' },
  { id: 'indonesia', label: 'Indonesia', kind: 'country', countries: 1, flag: '🇮🇩', region: 'Asia-Pacific' },
  { id: 'italy', label: 'Italy', kind: 'country', countries: 1, flag: '🇮🇹', region: 'Europe' },
  { id: 'japan', label: 'Japan', kind: 'country', countries: 1, flag: '🇯🇵', region: 'Asia-Pacific' },
  { id: 'malaysia', label: 'Malaysia', kind: 'country', countries: 1, flag: '🇲🇾', region: 'Asia-Pacific' },
  { id: 'mexico', label: 'Mexico', kind: 'country', countries: 1, flag: '🇲🇽', region: 'Latin America' },
  { id: 'morocco', label: 'Morocco', kind: 'country', countries: 1, flag: '🇲🇦', region: 'Africa' },
  { id: 'new-zealand', label: 'New Zealand', kind: 'country', countries: 1, flag: '🇳🇿', region: 'Oceania' },
  { id: 'portugal', label: 'Portugal', kind: 'country', countries: 1, flag: '🇵🇹', region: 'Europe' },
  { id: 'singapore', label: 'Singapore', kind: 'country', countries: 1, flag: '🇸🇬', region: 'Asia-Pacific' },
  { id: 'south-africa', label: 'South Africa', kind: 'country', countries: 1, flag: '🇿🇦', region: 'Africa' },
  { id: 'south-korea', label: 'South Korea', kind: 'country', countries: 1, flag: '🇰🇷', region: 'Asia-Pacific' },
  { id: 'spain', label: 'Spain', kind: 'country', countries: 1, flag: '🇪🇸', region: 'Europe' },
  { id: 'switzerland', label: 'Switzerland', kind: 'country', countries: 1, flag: '🇨🇭', region: 'Europe' },
  { id: 'thailand', label: 'Thailand', kind: 'country', countries: 1, flag: '🇹🇭', region: 'Asia-Pacific' },
  { id: 'turkey', label: 'Turkey', kind: 'country', countries: 1, flag: '🇹🇷', region: 'Europe' },
  { id: 'uae', label: 'UAE', kind: 'country', countries: 1, flag: '🇦🇪', region: 'Middle East' },
  { id: 'united-kingdom', label: 'United Kingdom', kind: 'country', countries: 1, flag: '🇬🇧', region: 'Europe' },
  { id: 'vietnam', label: 'Vietnam', kind: 'country', countries: 1, flag: '🇻🇳', region: 'Asia-Pacific' },
];
